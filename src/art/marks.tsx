...
const SIGIL: Record<string, ReactNode> = {
  ...
  // ---- a second pass -------------------------------------------------------
  // Same grammar as everything above: 24x24, 1.7 stroke, nothing outside
  // 3..21, and each one wearing its school's motif so the family reads before
  // the name does.

  // entropy — circles that have not finished deciding
  unsettle: (
    <>
      <circle cx={12} cy={12} r={6.6} strokeDasharray="3 3" />
      <path d="M12 8.2v4.2" />
      <Dot x={12} y={15.8} r={1.5} />
    </>
  ),
  decay: (
    <>
      <path d="M5 8.4a7.6 7.6 0 0 1 14 0" />
      <path d="M6.4 13.4a6 6 0 0 1 11.2 0" strokeDasharray="2.6 2.6" />
      <path d="M8 18.2a4.2 4.2 0 0 1 8 0" strokeDasharray="1.8 3" />
    </>
  ),
  unkind_eye: (
    <>
      <path d="M3.8 12c2.6-3.4 5.3-5.2 8.2-5.2s5.6 1.8 8.2 5.2c-2.6 3.4-5.3 5.2-8.2 5.2S6.4 15.4 3.8 12Z" />
      <Dot x={12} y={12} r={2.2} />
  ...
  mirror_mask: (
    <>
      <path d="M12 4.6c4.2 0 7 2.8 7 7s-3 8-7 8Z" />
      <path d="M12 4.6c-4.2 0-7 2.8-7 7s3 8 7 8" strokeDasharray="2.6 2.4" />
      <Dot x={15.4} y={10.4} r={1.4} />
    </>
  ),
  nightfall: (
    <>
      <path d="M4 15.4h16" />
      <path d="M15.6 4.6a5.4 5.4 0 1 0 0 9.4 6.4 6.4 0 0 1 0-9.4Z" />
      <path d="M5.6 19.4h4M13 19.4h5.4" />
    </>
  ),
  ...
  stall: (
    <>
      ...
      <path d="M9.6 9v6M14.4 9v6" />
    </>
  ),
  premonition: (
    <>
      <circle cx={12} cy={12} r={7.2} strokeDasharray="3.2 2.6" />
  ...
  borrowed_time: (
    <>
      ...
      <path d="M17.6 4.4 20.2 7l-2.6 2.6" />
    </>
  ),
  ...
  weld: (
    <>
      <rect x={3.6} y={8.4} width={9.6} height={7.2} rx={3.6} />
      <rect x={10.8} y={8.4} width={9.6} height={7.2} rx={3.6} />
      <path d="M12 8.4v7.2" strokeWidth={2.6} />
    </>
  ),
  yoke: (
    <>
      <circle cx={7} cy={13.6} r={3.6} />
      <circle cx={17} cy={13.6} r={3.6} />
      <path d="M7 10V6.6h10V10" />
    </>
  ),
  ...
  erase: (
    <>
      <path d="M4.4 15.6 11 9l4.4 4.4-6.6 6.6H6a1.6 1.6 0 0 1-1.6-1.6Z" />
      <path d="M11 9 14.4 5.6a1.8 1.8 0 0 1 2.6 0l2.4 2.4a1.8 1.8 0 0 1 0 2.6L15.4 14" />
      <path d="M8.8 20h10.4" />
    </>
  ),
  salt_the_earth: (
    <>
      <path d="M4 17.6h16" />
      <path d="M7.6 17.6V12M12 17.6V9.6M16.4 17.6V12" strokeDasharray="2 2.2" />
      <Dot x={7.6} y={6.6} r={1.3} />
      <Dot x={12} y={5} r={1.3} />
      <Dot x={16.4} y={6.6} r={1.3} />
    </>
  ),
  ...
  counterfeit: (
    <>
      <rect x={4} y={6.4} width={11} height={13.2} rx={1.6} />
      <rect x={9} y={4.4} width={11} height={13.2} rx={1.6} />
      <path d="M12.4 9.4h4.2M12.4 12.4h2.6" />
    </>
  ),
  unweave: (
    <>
      <path d="M4.4 6.4 12 12M4.4 17.6 12 12" />
      <path d="M14.4 9.2c2.6-1.4 4.4-1.2 5.4.6M14.4 14.8c2.6 1.4 4.4 1.2 5.4-.6" strokeDasharray="2.4 2.4" />
      <Dot x={12} y={12} r={1.6} />
    </>
  ),
  first_draft: (
    <>
      <path d="M5.6 19.4 4.4 15l9.4-9.4a1.8 1.8 0 0 1 2.6 0l1.6 1.6a1.8 1.8 0 0 1 0 2.6L10 19.4Z" />
      <path d="M12.6 7.6 16.4 11.4" />
      <Dot x={5.6} y={19.4} r={1.3} />
    </>
  ),
};
...
const RELIC: Record<string, ReactNode> = {
  ...
  // ---- a second shelf ------------------------------------------------------
  // Relics stay objects: a thing you could pick up and put in a pocket.
  split_focus: (
    <>
      <path d="M12 20V13.2" />
      <path d="M12 13.2 6.6 7.8M12 13.2l5.4-5.4" />
      <Dot x={6.6} y={6.2} r={1.7} />
      <Dot x={17.4} y={6.2} r={1.7} />
    </>
  ),
  thrift: (
    <>
  ...
  open_palm: (
    <>
      <path d="M7 19.2v-6.4a1.5 1.5 0 0 1 3 0V8.2a1.5 1.5 0 0 1 3 0v4.6a1.5 1.5 0 0 1 3 0v3" />
      <path d="M7 12.8 5.2 14.6a1.8 1.8 0 0 0 0 2.6l2.4 2.4" />
      <Dot x={16.8} y={5.6} r={1.4} />
    </>
  ),
  ladder: (
    <>
      <path d="M8 4.4v15.2M16 4.4v15.2" />
      <path d="M8 8.2h8M8 12h8M8 15.8h8" />
    </>
  ),
  gilt_edge: (
    <>
      <rect x={5.6} y={4.4} width={12.8} height={15.2} rx={1.6} />
      <path d="M8.4 4.4v15.2" strokeWidth={2.6} />
      <Dot x={14.4} y={12} r={1.5} />
    </>
  ),
  twin_suns: (
    <>
      <circle cx={8.6} cy={12} r={3.4} />
      <circle cx={16.4} cy={12} r={3.4} />
      <path d="M8.6 5.6V4M16.4 20v-1.6M3.4 12H4.8M19.2 12h1.4" />
    </>
  ),
  unsettled: (
    <>
      <rect x={5.6} y={4.6} width={12.8} height={14.8} rx={1.6} strokeDasharray="3 2.6" />
      <path d="M12 9v3.6" />
      <Dot x={12} y={15.6} r={1.5} />
    </>
  ),
  the_usurer: (
    <>
      <circle cx={12} cy={12} r={7.2} />
      <path d="M9.6 9.2h4.2a1.9 1.9 0 0 1 0 3.8h-3.4l3.8 3.8" />
    </>
  ),
  cold_read: (
    <>
      <circle cx={10.4} cy={10.4} r={5.4} />
      <path d="M14.4 14.4 19.6 19.6" />
      <path d="M7.8 10.4h5.2" />
    </>
  ),
  the_gambler: (
    <>
      <rect x={4.4} y={4.4} width={15.2} height={15.2} rx={2.4} />
      <Dot x={8.4} y={8.4} r={1.5} />
      <Dot x={15.6} y={15.6} r={1.5} />
      <Dot x={12} y={12} r={1.5} />
    </>
  ),
  low_road: (
    <>
      <path d="M4 18.6c3.4 0 4.2-9.2 8-9.2s4.6 9.2 8 9.2" />
      <path d="M4 18.6h16" strokeDasharray="2.4 2.4" />
    </>
  ),
  the_archive: (
    <>
      <rect x={4.4} y={6} width={15.2} height={12} rx={1.6} />
      <path d="M4.4 10.4h15.2M4.4 14.4h15.2" />
      <path d="M10.4 8.2h3.2M10.4 12.2h3.2M10.4 16.2h3.2" />
    </>
  ),
  the_hoard: (
    <>
      <path d="M4.6 19.4h14.8" />
      <circle cx={9} cy={16.4} r={2.6} />
      <circle cx={15} cy={16.4} r={2.6} />
      <circle cx={12} cy={11.4} r={2.6} />
      <Dot x={12} y={5.8} r={1.5} />
    </>
  ),
  the_long_game: (
    <>
      <circle cx={12} cy={12} r={7.2} />
      <path d="M12 6.2V12l4.2 2.6" />
      <path d="M12 19.8v-1.6" strokeWidth={2.6} />
    </>
  ),
};
...
const OMEN: Record<string, ReactNode> = {
  ...
  // ---- later omens ---------------------------------------------------------
  // Omens stay conditions over the table: a horizon, weather, a level.
  the_crowded_board: (
    <>
      <path d="M3.4 16.6h17.2" />
      <rect x={4.4} y={8} width={4} height={6} rx={1} />
      <rect x={10} y={8} width={4} height={6} rx={1} />
      <rect x={15.6} y={8} width={4} height={6} rx={1} />
      <Dot x={12} y={19.4} r={1.3} />
    </>
  ),
  the_ladder: (
    <>
      <path d="M4 19.2h16" />
      <path d="M6.6 19.2v-4M11 19.2v-8M15.4 19.2v-12" />
      <Dot x={15.4} y={4.6} r={1.4} />
    </>
  ),
  the_tide: (
    <>
      <path d="M3.8 9.6c2.7-2.2 5.4 2.2 8.2 0s5.5 2.2 8.2 0" />
      <path d="M3.8 14c2.7-2.2 5.4 2.2 8.2 0s5.5 2.2 8.2 0" />
      <path d="M3.8 18.4c2.7-2.2 5.4 2.2 8.2 0s5.5 2.2 8.2 0" />
    </>
  ),
  the_drought: (
    <>
      <path d="M3.8 17.6h16.4" strokeDasharray="2.6 2.8" />
      <path d="M12 4.6c2.6 2.8 4 5 4 6.6a4 4 0 0 1-8 0c0-1.6 1.4-3.8 4-6.6Z" strokeDasharray="3 2.6" />
    </>
  ),
  the_court_masked: (
    <>
      <path d="M4.4 9.6h15.2v3.2c0 3.4-3.4 6.2-7.6 6.2s-7.6-2.8-7.6-6.2Z" />
      <path d="M7.6 9.6 9.2 5h5.6l1.6 4.6" />
      <Dot x={9.2} y={13} r={1.4} />
      <Dot x={14.8} y={13} r={1.4} />
    </>
  ),
  the_undertow: (
    <>
      <path d="M3.8 7.6c2.7 2.2 5.4-2.2 8.2 0s5.5-2.2 8.2 0" />
      <path d="M12 11v7.2" />
      <path d="M8.8 15 12 18.6 15.2 15" />
    </>
  ),
  the_bindings: (
    <>
      <path d="M3.8 18.8h16.4" />
      <rect x={4.6} y={9.4} width={7.6} height={5.6} rx={2.8} />
      <rect x={11.8} y={9.4} width={7.6} height={5.6} rx={2.8} />
      <path d="M12 5.4v4" />
    </>
  ),
  the_quickening: (
    <>
      <path d="M3.8 18.8h16.4" />
      <path d="M13.4 4.2 8 12.6h4.2L10.6 19.8 16.4 11h-4.2Z" />
    </>
  ),
  the_undecided: (
    <>
      <path d="M3.8 18.8h16.4" />
      <circle cx={12} cy={10.4} r={5.6} strokeDasharray="3 2.8" />
      <path d="M12 7v3.4" />
      <Dot x={12} y={13.4} r={1.4} />
    </>
  ),
  the_wellspring: (
    <>
      ...
      <path d="M6.6 19.4v-4.2a5.4 5.4 0 0 1 10.8 0v4.2" />
      <path d="M12 10.6V4.4" />
      <path d="M9.4 6.6 12 4l2.6 2.6" />
    </>
  ),
};
